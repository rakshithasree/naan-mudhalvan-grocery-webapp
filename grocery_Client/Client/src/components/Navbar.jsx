  ...
  return (
    ...
    <>
      ...
      {!usertype ?
          ...
          <h3 onClick={()=> navigate('')}>Grocery Mart</h3>
          <div className="nav-content">
            <div className="nav-search">
              <input type="text" name="nav-search" id="nav-search" placeholder='Search' onChange={(e)=>setProductSearch(e.target.value)} />
        ...
        : <>
            ...
            {usertype === 'customer' ?
              ...
              <div className="navbar-admin">
                <h3 onClick={()=> navigate('/admin')}>Grocery Mart (admin)</h3>
